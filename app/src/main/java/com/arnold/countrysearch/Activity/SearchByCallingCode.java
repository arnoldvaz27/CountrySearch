...
public class SearchByCallingCode extends AppCompatActivity implements CountryListeners {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.searchbycallingcode);
        ...
        search.requestFocus();
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(SearchByCallingCode.this);
    ...
    private void Fetching() {
        ...
        loadingBar.show();
        url = "https://restcountries.eu/rest/v2/callingcode/"+search.getText().toString();
    ...
    private void Display() {
        ...
        countryAdapter = new CountryAdapter(countriesList, SearchByCallingCode.this);
