...
public class SearchByCapital extends AppCompatActivity implements CountryListeners {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        search.requestFocus();
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(SearchByCapital.this);
    ...
    private void Fetching() {
        ...
        loadingBar.show();
        url = "https://restcountries.eu/rest/v2/capital/"+search.getText().toString();
    ...
    private void Display() {
        ...
        countryAdapter = new CountryAdapter(countriesList, SearchByCapital.this);
    ...
    private void Info() {
        AlertDialog.Builder builder = new AlertDialog.Builder(SearchByCapital.this,R.style.AlertDialog);
        builder.setTitle("Important Note");
        builder.setCancelable(false);

        final TextView groupNameField = new TextView(SearchByCapital.this);
        groupNameField.setText("1) Type the capital name of the country. \n\n2) After typing the capital name in the box press the search image in front of the text, if the code put by you is correct the results will be shown else a red box will be pop up showing some error.");
