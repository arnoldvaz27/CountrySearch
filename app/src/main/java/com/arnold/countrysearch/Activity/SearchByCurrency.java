...
public class SearchByCurrency extends AppCompatActivity implements CountryListeners {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        search.requestFocus();
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(SearchByCurrency.this);
    ...
    private void Display() {
        ...
        countryAdapter = new CountryAdapter(countriesList, SearchByCurrency.this);
